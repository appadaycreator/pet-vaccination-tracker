...
const SVC_URL = "https://appadaycreator.com/pet-vaccination-tracker/";
const SVC_NAME = "ペットワクチン・健康記録";

test.describe("ペットワクチン・健康記録 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("pet-vaccination-tracker");
